const ZH = {
  ...
  resultCounts: "全部 {all} 条 · 额度相关 {relevant} 条（重置 {reset} 条）",
  ...
  waitingFirstBackfill: "等待首次 72 小时补查", diagnosticsSummary: "查看按日期检查诊断", diagnosticProfile: "主页回退", diagnosticComplete: "正常结束", diagnosticIncomplete: "未完整结束", diagnosticCounts: "本次 {scanAll} 条 / 相关 {scanRelevant} 条 · 累计已知 {knownAll} 条 / 相关 {knownRelevant} 条 · 滚动 {scrolls} 次", diagnosticProfileCounts: "本次 {scanAll} 条 / 相关 {scanRelevant} 条 · 滚动 {scrolls} 次",
